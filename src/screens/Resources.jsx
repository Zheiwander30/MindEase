...
const SUPPORT_CATEGORIES = [
    ...
    services: [
      {
        ...
        action: 'https://counseling.school.edu', // ← replace with your school's link
  ...
  },
  {
    ...
    services: [
      ...
      {
        id: 'iwillbe',
        name: 'I Will Be — Online Crisis Chat',
        detail: 'Chat-based crisis support for Filipinos who prefer typing over calling. Available evenings.',
        contact: 'iwillbe.ph',
        action: 'https://www.iwillbe.ph',
        actionLabel: 'Open chat',
        badge: 'Chat · Evenings',
        keywords: ['crisis', 'chat', 'online', 'philippines', 'iwillbe'],
      },
    ],
  },
];
